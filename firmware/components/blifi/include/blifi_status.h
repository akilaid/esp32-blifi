...
typedef enum {
    ...
    BLIFI_STATUS_HANDSHAKE_IN_PROGRESS  = 0x01, /*!< BLE handshake underway */
    BLIFI_STATUS_HANDSHAKE_OK           = 0x02, /*!< Session established */
    ...
    /* Errors */
    BLIFI_STATUS_AUTH_FAILED            = 0x20, /*!< Wrong PoP / confirmation mismatch */
    ...
    BLIFI_STATUS_PROV_TIMEOUT           = 0x25, /*!< Provisioning window elapsed */
    BLIFI_STATUS_INVALID_MESSAGE        = 0x26, /*!< Malformed / failed-auth frame */
